...
The next milestone adds a minimal Docker image. T152 hardened semantic admin
IDs/cursors, upstream URL startup validation, structured error logging, and
early request-line limits; T154 audited control-plane secret redaction and
hardened credential-bearing error/header surfaces. The remaining work covers
container packaging and compose. No Web UI, provider routing, retries, Redis,
or PostgreSQL.
